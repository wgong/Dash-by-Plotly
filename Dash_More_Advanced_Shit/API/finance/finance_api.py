...
# key = '864W8511Y0FXY2ZN4' # Your API Key
key = json.load(open("alpha-vantage-api.key.json"))["key"] # '7FEDJMHY3CM2KPEC' # Your API Key
...
def update_graph(n):
    ...
    line_chart = px.line(
                    ...
                    y='rate',
                    color='indicator',
                    title="Stock: {}".format(quote_meta_data['2. Symbol'])
                 )
    return (line_chart)
